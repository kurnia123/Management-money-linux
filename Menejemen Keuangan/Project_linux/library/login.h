...
public:
	...
	int DataLogin(Pembaruan baru)
	{
		...
		mkdir("Database/Data_account", S_IRWXU | S_IRWXG | S_IRWXO);
		...
		if (T.pilih==1)
		{
			...
			if (cek)
			{
				cout << "data sudah ada, gunakan nama yang lain" << endl;
				cek.close();
			}
			...
			else
			{
			    ...
			    mkdir(coba1, S_IRWXU | S_IRWXG | S_IRWXO);
			    ...
			    mkdir(pengeluaran_dir, S_IRWXU | S_IRWXG | S_IRWXO);
			    mkdir(pemasukan_dir, S_IRWXU | S_IRWXG | S_IRWXO);
			    mkdir(saldo_dir, S_IRWXU | S_IRWXG | S_IRWXO);
			    mkdir(pengeluaran_dir_total, S_IRWXU | S_IRWXG | S_IRWXO);
			    mkdir(pemasukan_dir_total, S_IRWXU | S_IRWXG | S_IRWXO);
			    //==================================================================================================================================================
